...
public class FighterPreTest {
	...
	public final void testSetPositionNull() {
		 ...
		 */
		Coordinate coordenada = new Coordinate(2,4);
		fighter.setPosition(coordenada);
		assertEquals(coordenada, fighter.getPosition());
	...
	public final void testToString1() {
		...
		assertEquals(fighter.toString(),sout, fighter.toString());
	}
	...
	public final void testToString2() {
		 ...
		 */
		final Coordinate c = new Coordinate(2,3);
		fighter.setPosition(c);
		fighter.addAttack(40);
		fighter.addShield(20);
		fighter.addVelocity(60);
		final String sout = "(XWing 1 REBEL [2,3] {160,120,100})";
		assertEquals(fighter.toString(),sout, fighter.toString());
